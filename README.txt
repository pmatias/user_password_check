...
This Drupal module adds a new command to [Drush](https://github.com/drush-ops/drush) to check for weak credentials and compare against a password list file (or several).
